...
if ($siteConfig) {
    ...
    # segments: handle flat (primary/secondary/excludedSegments) AND nested (readerSegments.*)
...
$promptLines.Add("- SKU: $Sku")
$promptLines.Add("- Piece type: review")
...
$promptLines.Add("make specific claims.")
$promptLines.Add("")
...
Write-Host "  - Write your ``## Bottom Line`` section in sites/$Site/src/content/reviews/$Slug.md"
