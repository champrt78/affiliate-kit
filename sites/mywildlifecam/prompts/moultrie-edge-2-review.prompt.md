# AI Drafting Prompt — MyWildlifeCam — Moultrie Edge 2
...
- Product: Moultrie Edge 2 (Moultrie)
- SKU: 
- Piece type: review
- Slug: moultrie-edge-2-review
- Pub date: 2026-05-28
...
Draft the markdown body of `moultrie-edge-2-review.md` per the scaffold below. The `## Bottom Line` section
