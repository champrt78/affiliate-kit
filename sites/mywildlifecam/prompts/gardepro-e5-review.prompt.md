# AI Drafting Prompt — MyWildlifeCam — GardePro E5 Trail Camera
...
- Product: GardePro E5 Trail Camera (GardePro)
- SKU: 
- Piece type: review
- Slug: gardepro-e5-review
- Pub date: 2026-05-23
...
Draft the markdown body of `gardepro-e5-review.md` per the scaffold below. The `## Bottom Line` section
...
```markdown
---
title: "GardePro E5 Trail Camera Review"
