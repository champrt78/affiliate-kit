# AI Drafting Prompt — MyWildlifeCam — Spypoint Flex G36
...
- Product: Spypoint Flex G36 (Spypoint)
- SKU: 
- Piece type: review
- Slug: spypoint-flex-g36-review
- Pub date: 2026-05-29
...
Draft the markdown body of `spypoint-flex-g36-review.md` per the scaffold below. The `## Bottom Line` section
