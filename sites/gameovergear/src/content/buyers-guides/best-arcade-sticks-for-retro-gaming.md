...
products:
  ...
  - name: "Mayflash Universal Arcade Fighting Stick F500"
    ...
    body: |
      ...
      <p>For modders the listing notes that the buttons are sized for standard 30mm snap-in parts and that an octagonal gate ships in the box, and it is built to accept Sanwa Denshi components. It holds a 4.6 out of 5 rating across 3,498 Amazon ratings. Amazon reviewers position it as a step up from the F300 for not much more money, with the extra internal space and included gate as the practical reasons to choose it as a modding base.</p>
  - name: "8BitDo Arcade Stick"
    ...
    body: |
      <p>The <a href="https://www.amazon.com/dp/B08GJC5WSS?tag=gameovergear-20" rel="sponsored noopener" target="_blank">8BitDo Arcade Stick</a> is the only wireless option in this guide. Its listing describes three ways to connect: Bluetooth, a 2.4 GHz receiver that stows in a hidden compartment, and wired USB-C, with compatibility for Switch and Windows. It carries a 16-button arcade layout, supports 8BitDo Ultimate Software for custom mapping and macros, and changes the on-screen button layout dynamically with the active mode. The list price is $89.99.</p>
      <p>It holds a 4.6 out of 5 rating across 4,461 Amazon ratings, the second-largest review sample here. The feature retro builders cite most is its universal mounting plate, which the listing states supports Sanwa arcade parts, so it doubles as a modding base like the Mayflash sticks. The trade-off versus those sticks is platform scope: the 8BitDo lists Switch and Windows only, with no PlayStation or Xbox support, in exchange for going wireless.</p>
...
If you play mostly on PlayStation, the Qanba Drone 2 is the light, officially licensed entry option for PS5, PS4, and PC, while the Razer Kitsune is the premium leverless choice for players who specifically want the all-button format. On Switch, the 8BitDo Arcade Stick is the one wireless pick and doubles as a Sanwa mod platform. And if you want a tournament-grade lever with replaceable artwork and Hori's Hayabusa parts, the Hori Fighting Stick Alpha is the premium Xbox and PC option, with the caveat that its parts feel is a different ecosystem from Sanwa. Match the stick to the system you play on first, then decide how far down the modding path you want to go.
