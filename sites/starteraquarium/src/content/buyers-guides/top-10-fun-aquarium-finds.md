...
products:
  - name: "Magnetic Betta Leaf Hammock"
    brand: "Aquarigram"
    affiliateUrl: "https://www.amazon.com/dp/B0BYWTFZ18?tag=mystarteraquarium-20"
    image: "https://m.media-amazon.com/images/I/71T5XWyk+EL._AC_SL1500_.jpg"
    bestFor: "The cheapest way to make a betta happy"
    priceFrom: 7.48
    priceUnit: "item"
    hook: "A soft silicone leaf that suction-mounts near the surface so your betta has a spot to lounge and rest, the way they do on leaves in the wild."
    reason: "The betta-pleaser:"
    facts:
      Type: "Resting leaf with suction mount"
  ...
  - name: "ALEGI Ceramic Betta Log Cave"
    ...
    image: "https://m.media-amazon.com/images/I/61KUw3-aU0L._AC_SL1500_.jpg"
    bestFor: "A hideout that doubles as decor"
    priceFrom: 9.99
    priceUnit: "item"
    hook: "A ceramic log cave that gives shy fish, shrimp, and small cichlids a place to hide and feel safe, which often means you actually see them out and about more."
    reason: "The cozy hideout:"
    facts:
      Type: "Ceramic cave / hideout"
  ...
  - name: "SLOCME Sunken Ship Air Bubbler Ornament"
    ...
    image: "https://m.media-amazon.com/images/I/61fJUs0AKML._AC_SL1500_.jpg"
    bestFor: "The classic shipwreck, with a bubble trick"
    priceFrom: 18.99
    priceUnit: "item"
    hook: "A sunken pirate ship that streams bubbles out of the wreck when you connect an air pump, the kind of moving centerpiece kids stare at."
    reason: "The showpiece:"
    facts:
      Type: "Resin ornament with air action"
  ...
  - name: "Live Marimo Moss Balls (4-Pack)"
    ...
    image: "https://m.media-amazon.com/images/I/61eeMoKvd5L._AC_SL1500_.jpg"
    bestFor: "The plant even brown thumbs can keep alive"
    priceFrom: 10.89
    priceUnit: "item"
    hook: "Fuzzy green spheres of living algae that need almost no care, no fancy lighting, no CO2, just an occasional roll to keep their shape."
    reason: "The no-fuss plant:"
    facts:
      Type: "Live aquatic plant (Marimo)"
  ...
  - name: "ZRDR Fish Feeding Ring (2-Pack)"
    ...
    image: "https://m.media-amazon.com/images/I/51V+StmCBiL._AC_SL1500_.jpg"
    bestFor: "Keeping food in one spot, not all over the tank"
    priceFrom: 6.39
    priceUnit: "item"
    hook: "A little floating ring that corrals flakes and pellets in one corner so food does not scatter across the surface and get sucked into the filter."
    reason: "The tidy feeder:"
    facts:
      Type: "Floating feeding ring (2-pack)"
  ...
  - name: "Penn-Plax Floating Aquarium Thermometer"
    ...
    image: "https://m.media-amazon.com/images/I/71-agAWfLXL._AC_SL1500_.jpg"
    bestFor: "Knowing your water temperature at a glance"
    priceFrom: 7.99
    priceUnit: "item"
    hook: "A cheap, easy-to-read floating thermometer so you can actually see whether your heater is doing its job, which matters a lot for tropical fish."
    reason: "The peace-of-mind check:"
    facts:
  ...
  - name: "Pawfly Air Stone Disc Bubbler (4-Pack)"
    ...
    image: "https://m.media-amazon.com/images/I/71ue-1kcacL._AC_SL1500_.jpg"
    bestFor: "A curtain of bubbles for cheap"
    priceFrom: 5.98
    priceUnit: "item"
    hook: "A small disc that turns an air pump into a soft column of fine bubbles, equal parts oxygen boost and relaxing visual."
    reason: "The bubble maker:"
    facts:
      Type: "Air stone disc (4-pack)"
  ...
  - name: "Aqueon Magnetic Algae Scraper"
    ...
    image: "https://m.media-amazon.com/images/I/81IsiYJ2TWL._AC_SL1500_.jpg"
    bestFor: "Cleaning the glass without wet sleeves"
    priceFrom: 9.53
    priceUnit: "item"
    hook: "Two magnets, one inside the tank and one outside, that let you wipe algae off the glass without ever rolling up your sleeves."
    reason: "The dry-hands cleaner:"
    facts:
      Type: "Magnetic glass cleaner"
  ...
  - name: "FUTUREPLUSX Blue Glass Pebbles"
    ...
    image: "https://m.media-amazon.com/images/I/71uMRwp3VtL._AC_SL1500_.jpg"
    bestFor: "An instant pop of color on the bottom"
    priceFrom: 6.99
    priceUnit: "item"
    hook: "A pound of smooth blue glass pebbles you can scatter over gravel or pile in a corner for a quick, cheap shot of color."
    reason: "The color pop:"
    facts:
      Type: "Decorative flat glass pebbles"
  ...
  - name: "Penn-Plax Spongebob Pineapple House Ornament"
    ...
    image: "https://m.media-amazon.com/images/I/81q80lS44VL._AC_SL1500_.jpg"
    bestFor: "The fun gift pick for a kid's first tank"
    priceFrom: 11.05
    priceUnit: "item"
    hook: "An officially licensed Spongebob pineapple house, a 2-piece set that turns a starter tank into a recognizable scene kids love."
    reason: "The crowd-pleaser:"
    facts:
      Type: "Licensed resin ornament (2-piece set)"
