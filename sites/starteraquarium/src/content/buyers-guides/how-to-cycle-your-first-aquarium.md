...
products:
  ...
  - name: "Seachem Prime"
    ...
    body: |
      <p>The <a href="https://www.amazon.com/dp/B00025694O?tag=mystarteraquarium-20" rel="sponsored noopener" target="_blank">Seachem Prime</a> does the job every aquarium needs no matter how you cycle: per the listing it immediately removes chlorine and chloramine from tap water, both of which are toxic to fish and to the very bacteria you are trying to grow. Any time you add tap water to the tank, that water needs conditioning first. The listing states 5 mL treats 50 US gallons, so a 500 mL bottle lasts a long time on a starter tank.</p>
      <p>Its second listed job is what makes it a fish-in cycling staple. The listing claims Prime detoxifies ammonia, nitrite, and nitrate for roughly 48 hours, converting them to a form the manufacturer describes as safe for fish while still available for your filter bacteria to consume. In plain terms, during a fish-in cycle it buys your fish a buffer against the ammonia and nitrite spikes that would otherwise harm them between water changes. Treat it as the safety net, not a substitute for testing and water changes.</p>
  - name: "Tetra SafeStart Plus"
    ...
    body: |
      <p>The <a href="https://www.amazon.com/dp/B002DZNP3E?tag=mystarteraquarium-20" rel="sponsored noopener" target="_blank">Tetra SafeStart Plus</a> is one of the two bacteria-starter bottles a beginner chooses between. Per the listing it contains live bacteria that begin working immediately to reduce ammonia and nitrite and to prevent new tank syndrome, the crash that kills fish in a brand-new uncycled tank. The product is built around fish-in cycling, the idea being you dose it and stock the tank rather than running empty for weeks.</p>
